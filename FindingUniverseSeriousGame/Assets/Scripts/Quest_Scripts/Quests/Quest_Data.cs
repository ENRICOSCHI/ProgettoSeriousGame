...
public class QuestData
{
    ...
    public List<string> oggettiSbloccati = new List<string>();
    ...
    public QuestData(bool isStarted, bool isCompleted, int amountProgress, List<string> oggettiSbloccati)
    {
        this.isStarted = isStarted;
        this.isCompleted = isCompleted;
        this.amountProgress = amountProgress;
        this.oggettiSbloccati = oggettiSbloccati;
    }
